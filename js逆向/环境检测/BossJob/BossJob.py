...
class BossJob:
    def __init__(self, js_name: str = ''):
        ...
        self.apiList: list[str] = [
            ...
            f'https://www.zhipin.com/job_detail/',  # 不需要指定params
    ...
    def search_job(self, position: str, city: str, startPage: int = 1) -> Iterator:
    ...
    def get_job_details_by_id(self, securityId: str) -> str:
        url = self.apiList[1] + securityId + '.html'
